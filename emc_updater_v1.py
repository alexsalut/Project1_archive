...
def emc_updater(date=None):
    ...
    tinlian_actual_pos_dir = r'\\192.168.1.116\trade\broker\emc\account'
    ...
    actual_position_0343_path = rf'{tinlian_actual_pos_dir}/310310300343_RZRQ_POSITION.{today}.csv'
...
def check_panlan1_file(actual_file_path, target_file_path):
    try:
        ...
        new_merge_df = pd.concat(merge_df, actual_df['名称'], axis=1, join='outer')
        return new_merge_df
