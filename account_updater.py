...
class Account:
    ...
    def update_account(self):
        self.update_panlan1(sheet_name='单策略超额')
        self.update_panlan1(sheet_name='多策略超额')
        ...
        send_email(subject='[CNN 策略观察] 更新完成', content=content, receiver=SendEmailInfo.department['research'])
    ...
    def update_panlan1(self, sheet_name):
        ...
        try:
            ...
            print(f'{self.account_path} with sheet name {sheet_name} updating failed, retry in 10 seconds')
            time.sleep(10)
            self.update_panlan1(sheet_name=sheet_name)
